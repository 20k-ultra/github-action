...
mkdir -p "$test_dir"
# Create a modified copy of the test_workflow.yml file using the provided repo url
sed "s!_ACTION_REPO_!$action_repo!g" "$(pwd)/test_workflow.yml" >"$test_dir/test.yml"
